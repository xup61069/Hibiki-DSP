...
| `src/` | C++20 RT graph、AudioEngine、session registry/Windows session adapter、Windows volume/device watcher/recovery、ISO math、IPC、persistent SRC、scene safety policy、sink crossfade | 可測試 user-space 骨架 | SPEC-0001/0002/0003/0006/0007 |
