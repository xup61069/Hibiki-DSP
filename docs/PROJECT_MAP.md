...
| `vst-host/` | Out-of-process VST3 host | trusted/certified model + Job Object supervisor + tested frame codec/named-pipe boundary + bounded passthrough worker + optional pinned SDK factory catalog/one-main-bus processor/worker executable；supervisor launch policy、parameter automation、latency policy pending | SPEC-0008 / plugin contract |
