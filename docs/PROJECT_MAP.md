...
| `vst-host/` | Out-of-process VST3 host | trusted/certified model + Job Object supervisor + tested frame codec/named-pipe boundary + bounded passthrough worker + optional pinned SDK factory catalog/one-main-bus processor/worker executable + bounded parameter frame + latency alignment/delay primitive；supervisor launch policy、graph latency commit、parameter automation pending | SPEC-0008 / plugin contract |
