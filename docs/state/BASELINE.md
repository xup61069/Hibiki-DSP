...
目前驗證摘要：`verify.ps1` 的 4 個 CTest（hibiki_contract_tests、hibiki_driver_stream_tests、hibiki_asio_transport_selftest、hibiki_tab_bridge_selftest）通過；`docs-check.ps1` 的 87 個必要入口與
